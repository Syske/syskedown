...
//
define(["require", "exports", "codemirror", "codemirror", "../core"], function (require, exports, CodeMirror, codemirror_1, core_1) {
    "use strict";
    ...
    exports.keyMap = (_a = {
        ...
        _a[modPrefix + "-1"] = createStyleToggler(function (state) { return state.strikethrough; }, function (token) { return / formatting-strikethrough /.test(token.type); }, function (state) { return "#"; }),
